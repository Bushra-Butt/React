...
export default function Carriculum() {
  ...
  //   }));
    ...
    function addfile(event) {
        ...
        // header.append('Access-Control-Allow-Origin','http://localhost:5000')
        setdata(arraylist)
        fetch('http://127.0.0.1:5000/getDataFromReact',{
          'method':'POST',
          mode:'cors',
    ...
    function uploadFile() {
          ...
          formData.append('ArrayList',data)
          const config={
